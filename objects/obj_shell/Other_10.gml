...
variable_global_set("meta_help", function() //gml_Script_anon_gml_Object_obj_shell_Other_10_2236_gml_Object_obj_shell_Other_10
{
    return 
    {
...
variable_global_set("sh_clear", function(argument0) //gml_Script_anon_gml_Object_obj_shell_Other_10_2562_gml_Object_obj_shell_Other_10
{
...
variable_global_set("meta_clear", function() //gml_Script_anon_gml_Object_obj_shell_Other_10_2979_gml_Object_obj_shell_Other_10
{
    return 
    {
        arguments: ["<all>"],
...
variable_global_set("sh_shell_set_width", function(argument0) //gml_Script_anon_gml_Object_obj_shell_Other_10_3311_gml_Object_obj_shell_Other_10
{
    if (array_length(argument0) > 1)
    {
...
variable_global_set("meta_shell_set_width", function() //gml_Script_anon_gml_Object_obj_shell_Other_10_3601_gml_Object_obj_shell_Other_10
{
    return 
    {
...
variable_global_set("sh_shell_set_height", function(argument0) //gml_Script_anon_gml_Object_obj_shell_Other_10_3881_gml_Object_obj_shell_Other_10
{
    if (array_length(argument0) > 1)
    {
        if (string_digits(argument0[1]) != "")
...
variable_global_set("meta_shell_set_height", function() //gml_Script_anon_gml_Object_obj_shell_Other_10_4173_gml_Object_obj_shell_Other_10
{
    return 
    {
...
variable_global_set("sh_shell_set_anchor_v", function(argument0) //gml_Script_anon_gml_Object_obj_shell_Other_10_4467_gml_Object_obj_shell_Other_10
{
    if (array_length(argument0) > 1)
    {
...
variable_global_set("meta_shell_set_anchor_v", function() //gml_Script_anon_gml_Object_obj_shell_Other_10_4855_gml_Object_obj_shell_Other_10
{
    return 
    {
...
variable_global_set("sh_shell_set_anchor_h", function(argument0) //gml_Script_anon_gml_Object_obj_shell_Other_10_5211_gml_Object_obj_shell_Other_10
{
    if (array_length(argument0) > 1)
    {
        var newAnchor = argument0[1]
...
variable_global_set("meta_shell_set_anchor_h", function() //gml_Script_anon_gml_Object_obj_shell_Other_10_5599_gml_Object_obj_shell_Other_10
{
    return 
    {
