...
layer_x("Assets_BG_1", (_cam_x * 0.05))
layer_y("Assets_BG_1", (_cam_y * 0.05))
...
layer_x("Backgrounds_sky", (_cam_x * 0.5))
layer_y("Backgrounds_sky", (_cam_y * 0.5))
layer_x("Backgrounds_long", (_cam_x * 0.98))
layer_y("Backgrounds_long", _cam_y)
...
layer_x("Backgrounds_stillH2", (bg_stillH2xoffset + _cam_x * 0.55))
...
layer_x("Backgrounds_stillH3", (bg_stillH3xoffset + _cam_x * 0.7))
layer_y("Backgrounds_stillH3", (bg_stillH3yoffset + _cam_y - (clamp((_cam_y * 0.15 * 540 / room_height), 0, (sprite_get_height(layer_background_get_sprite(layer_background_get_id(layer_get_id("Backgrounds_stillH3")))) - 540)))))
layer_x("Backgrounds_scroll", (_cam_x * 0.45 + bg_scrollx + bg_scrollxoffset))
layer_y("Backgrounds_scroll", (_cam_y * 0.45 + bg_scrolly + bg_scrollyoffset))
layer_x("Backgrounds_scrollclose", (_cam_x * 0.15 + bg_scrollx + bg_scrollxoffset))
layer_y("Backgrounds_scrollclose", (_cam_y * 0.15 + bg_scrolly + bg_scrollyoffset))
bg_scrollx += layer_get_hspeed("Backgrounds_scroll")
bg_scrolly += layer_get_vspeed("Backgrounds_scroll")
bg_scrollx += layer_get_hspeed("Backgrounds_scrollclose")
bg_scrolly += layer_get_vspeed("Backgrounds_scrollclose")
bg_scrollx += layer_get_hspeed("Backgrounds_stillscroll")
bg_scrolly += layer_get_vspeed("Backgrounds_stillscroll")
bg_scroll3x += layer_get_hspeed("Foreground_scroll")
...
layer_x("Tiles_1BG", (_cam_x * 0.3 - 2000))
...
layer_x("Foreground_scroll", (_cam_x * 0.1 + bg_scroll3x + bg_scroll3xoffset))
layer_y("Foreground_scroll", _cam_y)
