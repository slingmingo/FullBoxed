...
with (other)
{
    if (!instance_exists(obj_fadeout))
    {
        ...
        {
            obj_player.verticalhall_vsp = -20
            obj_player1.verticalhall_vsp = -20
            obj_player2.verticalhall_vsp = -20
            verticalstate = states.layerlaunch
            xscale = 1
