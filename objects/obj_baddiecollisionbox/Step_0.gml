...
for (var i = 0; i < 2; i++)
{
    ...
    if (instance_exists(baddieID) && place_meeting(x, y, _obj_player) && _obj_player.cutscene == 0)
    {
        if (baddieID.state != states.grabbed && (!baddieID.invincible) && baddieID.state != states.ghostpossess)
        {
            with (_obj_player)
            {
                if (instance_exists(other.baddieID) && y < other.baddieID.y && attacking == 0 && (!global.kungfu) && sprite_index != spr_mach2jump && ((state == states.boots && vsp > 0) || state == states.jump || state == states.mach1 || state == states.grab) && vsp > 0 && other.baddieID.vsp >= 0 && sprite_index != spr_stompprep && (!other.baddieID.invincible))
                {
                ...
                if (instance_exists(other.baddieID) && other.baddieID.state != 205 && (!other.baddieID.invincible) && state == states.ratmountattack)
                {
                    other.baddieID.ratplayerid = id
                    other.baddieID.state = 205
                ...
                {
                    if (instance_exists(other.baddieID) && y < (other.baddieID.y - 50) && attacking == 0 && state != states.handstandjump && other.baddieID.state != states.grabbed && sprite_index != spr_mach2jump && (state == states.jump || state == states.mach1 || (state == states.grab && sprite_index != spr_swingding)) && vsp > 0 && other.baddieID.vsp >= 0 && sprite_index != spr_stompprep && other.object_index != obj_junk && (!other.baddieID.invincible))
                    {
                        scr_soundeffect(sfx_stompenemy)
                        if (x != other.baddieID.x)
                            other.baddieID.image_xscale = (-(sign(other.baddieID.x - x)))
