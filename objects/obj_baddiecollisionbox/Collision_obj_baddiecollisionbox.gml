if (instance_exists(baddieID) && instance_exists(other.baddieID) && baddieID.thrown != 1 && (!other.baddieID.mach3destroy) && baddieID.state != states.hit && other.baddieID.thrown == 1 && other.baddieID.state != states.hit && baddieID.killbyenemy && baddieID != other.id && baddieID.state != states.grabbed && (!baddieID.invincible) && baddieID.instantkillable && ((global.attackstyle != 2 && (!global.kungfu)) || baddieID.hp <= 0) && (!global.kungfu))
{
