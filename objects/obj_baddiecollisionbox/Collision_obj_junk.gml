if (instance_exists(baddieID) && baddieID.state != states.hit && baddieID.invtime == 0 && other.thrown == 1 && (!baddieID.invincible) && (other.object_index != obj_pepjunk || (!other.noisethrow)) && baddieID.destroyable)
{
