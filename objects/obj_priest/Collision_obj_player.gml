...
with (other)
{
    ...
    {
        if (state == states.mort || state == states.mortjump || state == states.morthook || state == states.mortjump || state == states.boxxedpep || state == states.boxxedpepjump || state == states.boxxedpepspin || state == states.clown || shotgunAnim == 1 || pistolAnim == 1)
        {
            if (hsp != 0)
                xscale = sign(hsp)
            movespeed = abs(hsp)
