...
function instance_place_list_movingPlatform(xx, yy, list = undefined) {
	var collided = 0;
	if (place_meeting(xx, yy, obj_movingplatformnew)) { // Basic moving Platforms		
		var movingplatform_number = instance_place_list(xx, yy, obj_movingplatformnew, global.MyCollisionList, false);
