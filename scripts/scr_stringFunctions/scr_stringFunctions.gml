function string_extract(argument0, argument1, argument2) //gml_Script_string_extract
{
...
function string_get_split(argument0, argument1) //gml_Script_string_get_split
{
    var slot = 0
    var splits = []
    var str2 = ""
...
function string_contains(argument0, argument1) //gml_Script_string_contains
{
...
function string_startswith(argument0, argument1) //gml_Script_string_startswith
{
    if (string_length(argument1) > string_length(argument0))
        return false;
...
function string_endswith(argument0, argument1) //gml_Script_string_endswith
{
    if (string_length(argument1) > string_length(argument0))
        return false;
