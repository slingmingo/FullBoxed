...
function DebugCommand(argument0, argument1, argument2, argument3) constructor //gml_Script_DebugCommand
{
    ...
    format = argument2
    func = argument3
    function TextList_Add_DebugCommand_gml_GlobalScript_scr_debug_commands(argument0) //gml_Script_TextList_Add_DebugCommand_gml_GlobalScript_scr_debug_commands
    {
