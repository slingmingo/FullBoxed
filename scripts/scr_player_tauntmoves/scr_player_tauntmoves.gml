function scr_player_tauntmoves() //gml_Script_scr_player_tauntmoves
{
    mach2 = 0
    ...
    if (sprite_index == spr_taunt || sprite_index == spr_supertaunt1 || sprite_index == spr_supertaunt2 || sprite_index == spr_supertaunt3 || sprite_index == spr_supertaunt4 || sprite_index == spr_supertaunt5 || sprite_index == spr_player_ratmounttaunt)
    {
        ...
        if (supercharged == 1 && (sprite_index == spr_supertaunt1 || sprite_index == spr_supertaunt2 || sprite_index == spr_supertaunt3 || sprite_index == spr_supertaunt4 || sprite_index == spr_supertaunt5) && (!instance_exists(obj_tauntaftereffectspawner)))
        {
    ...
    if (floor(image_index) == (image_number - 1) && (sprite_index == spr_supertaunt1 || sprite_index == spr_supertaunt2 || sprite_index == spr_supertaunt3 || sprite_index == spr_supertaunt4 || sprite_index == spr_supertaunt5))
    {
