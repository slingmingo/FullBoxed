function scr_player_boxxedpepjump() //gml_Script_scr_player_boxxedpepjump
{
    ...
    {
        jumpstop = 0
        sprite_index = spr_boxxedpepjump
        scr_soundeffect(choose(sfx_boxxedflap1, sfx_boxxedflap2, sfx_boxxedflap3, sfx_boxxedflap4))
        image_index = 0
        repeat (7)
        {
    ...
    if (sprite_index == spr_boxxedpepjump && floor(image_index) == (image_number - 1))
