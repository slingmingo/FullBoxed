function Instakill() //gml_Script_Instakill
{
    if (other.baddieID.elitegrab == 0)
    {
        ...
        if (state == states.mach3 && sprite_index != spr_mach3hit && sprite_index != spr_playerV_machhit1 && sprite_index != spr_playerV_machhit2 && (character == "P" || character == "V"))
        {
            if (fightball == 0)
            {
                if (character != "V")
                    ...
                    sprite_index = choose(spr_playerV_machhit1, spr_playerV_machhit2)
            }
            image_index = 0
        }
